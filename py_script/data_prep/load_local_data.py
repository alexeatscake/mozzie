...
def main(config_path: str):
    ...
    local_data_train = load_local_values(os.path.dirname(config_path), train_config)
    ...
    local_data_test = load_local_values(os.path.dirname(config_path), test_config)
    X_test, y_test = contruct_local_x_and_y(local_data_test, sample_values_test)
    print("X test shape:", X_test.shape)
    print("y test shape:", y_test.shape)

    processed_data_dir = os.path.join(os.path.dirname(config_path), "processed_local")
